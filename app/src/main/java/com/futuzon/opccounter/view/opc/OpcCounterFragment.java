    ...
    private View.OnClickListener getOnClickListenerBodyWeight() {
        return new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                new NumberPickers(getActivity()).showNumberPickerDialog(R.string.c_opc_body_weight, App.getStringByRId(R.string.body_weight), 2, 150);
            }
        };
    }
    ...
    private View.OnClickListener getOnClickListenerOpcShare() {
        return new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                new NumberPickers(getActivity()).showNumberPickerDialog(R.string.c_opc_share_within_grape_seed_extract, App.getStringByRId(R.string.opc_share), 1, 100);
            }
        };
    ...
    private View.OnClickListener getOnClickListenerOpcAmountPerKg() {
        return new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                new NumberPickers(getActivity()).showNumberPickerDialog(R.string.c_opc_amount_per_body_weight, App.getStringByRId(R.string.opc_per_body_weight), 1, 10);
